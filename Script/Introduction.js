...
dropTarget[i].addEventListener('drop', function(event) {dropValue++;
...
if(window.innerWidth > 650 && window.innerHeight>600){document.getElementsByClassName("detailtext")[j].style.fontSize=(window.innerWidth*(1.25/100)) + "px";
